                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="db_doctor.php" method="post" id="form_sample_1" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                                <label class="control-label col-md-3">Mentors Name
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">By Cheque No.
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input type="text" name="cheque_no" data-required="1" placeholder="enter cheque_no" class="form-control input-height" /> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="Sale%" type="deposite_account_no" placeholder="Deposite Account No." class="form-control input-height" /> </div>
                                            </div>
                                        	 ...
                                        	 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="acc_no" placeholder="Account No." class="form-control-textarea"  ></textarea>
                                                </div>
                                            </div>
