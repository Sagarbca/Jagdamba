                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="db_doctor.php" method="post" id="form_sample_1" class="form-horizontal">
										...
										<div class="form-group row">
											...
											<div class="form-group row">
                                                <label class="control-label col-md-3">Vendors Name
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input type="text" name="name" data-required="1" placeholder="name" class="form-control input-height" /> </div>
                                            </div>
                                            </div>
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="material" data-required="1" placeholder="material" class="form-control input-height" /> </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Particulars
                                                </label>
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        
                                                        <input type="text" class="form-control input-height" name="particular" placeholder="particular"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="quantity" data-required="1" placeholder="enter quantity" class="form-control input-height" /> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="rate" type="text" placeholder="rate" class="form-control input-height" /> </div>
                                            </div>
                                        	 ...
                                        	 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="gst" placeholder="gst" class="form-control-textarea"  ></textarea>
                                                </div>
                                            </div>
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="amount" placeholder="amount" class="form-control-textarea"  ></textarea>
                                                </div>
                                            </div>
