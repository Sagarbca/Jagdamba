                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="db_doctor.php" method="post" id="form_sample_1" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                                <label class="control-label col-md-3">No of job
												
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input type="text" name="no_of_job" data-required="1" placeholder="No of job
												" class="form-control input-height" /> </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Printed Item
                                                </label>
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        
                                                        <input type="printed_item" class="form-control input-height" name="Printed Item" placeholder="Consignee GSTIN NO"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="sheet" name="sheet" data-required="1" placeholder="enter sheet" class="form-control input-height" /> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="total_amount" type="Total Amount" placeholder="Total Amount" class="form-control input-height" /> </div>
                                            </div>
                                        	 ...
                                        	 <div class="form-group row">
                                                <label class="control-label col-md-3">Payments
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <textarea name="payments" placeholder="Payments" class="form-control-textarea"  ></textarea>
                                                </div>
                                            </div>
