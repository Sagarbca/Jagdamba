	                        ...
	                        <div class="white-box">
	                            ...
	                            <div class="row">
	                                <div class="col-md-12">
										<div class="pull-left">
											<address>
												<img src="img/logo.png"  style="height:100px; width:100px;" alt="logo" class="logo-default" />
												<p class="text-muted m-l-5">
													D 103, JAGDAMBA PRINT LINE, <br> Opp. Town Hall, <br>
													Sardar Patel Road, <br> Patna - 4
												</p>
											</address>
										</div>
