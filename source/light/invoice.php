        ...
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    ...
                    <span class="logo-default" >JAGDAMBA PRINT LINE</span> </a>
                </div>
                <!-- logo end -->
                        ...
                        <!-- start message dropdown -->
 						...
 						<li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <span class="username username-hide-on-mobile">Mr.Sahil Sanjan </span>
	                ...
	                <div id="remove-scroll" class="left-sidemenu">
	                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
	                                <li class="nav-item  ">
	                                    <a href="invoice.php" class="nav-link "> <span class="title"> Add Invoice</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item  ">
	                                    <a href="invoice_reports.php" class="nav-link "> <span class="title"> invoice Reports</span>
	                                    </a>
	                                </li>
	                               <li class="nav-item  ">
	                                    <a href="purchase_reports.php" class="nav-link "> <span class="title">Purchase Reports</span>
	                                    </a>
	                                </li>
	                                 
	                                <li class="nav-item  ">
	                                    <a href="add_purchase.php" class="nav-link "> <span class="title">Add purchase details</span>
	                                    </a>
	                                </li>
									 <li class="nav-item  ">
	                                    <a href="add_payments.php" class="nav-link "> <span class="title">Add Sale Payments</span>
	                                    </a>
	                                </li>
									 <li class="nav-item  ">
	                                    <a href="payment_reports.php" class="nav-link "> <span class="title">Sale Payments Reports</span>
	                                    </a>
	                                </li>
									 <li class="nav-item  ">
	                                    <a href="add_mentors.php" class="nav-link "> <span class="title">Add Mentors Eduserv</span>
	                                    </a>
	                                </li>
									 <li class="nav-item  ">
	                                    <a href="mentors_reports.php" class="nav-link "> <span class="title">Mentors Eduserv Reports</span>
	                                    </a>
	                                </li>
									<li class="nav-item  ">
	                                    <a href="add_vendors.php" class="nav-link "> <span class="title">Vendor Details</span>
	                                    </a>
	                                </li>
									<li class="nav-item  ">
	                                    <a href="vendor_reports.php" class="nav-link "> <span class="title">Vendor Details Reports</span>
	                                    </a>
	                                </li>
	                        ...
	                        <li class="nav-item  ">
	                            <a href="#" class="nav-link nav-toggle"> <i class="material-icons">person</i>
								 ...
								 <ul class="sub-menu">
	                                <li class="nav-item  ">
	                                    <a href="invoice.php" class="nav-link "> <span class="title"> HMVL</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item  ">
	                                    <a href="invoice_reports.php" class="nav-link "> <span class="title"> MENTORS</span>
	                                    </a>
	                                </li>
	                               <li class="nav-item  ">
	                                    <a href="purchase_reports.php" class="nav-link "> <span class="title">DAINIK BHASKAR</span>
	                                    </a>
	                                </li>
	                                 
	                                <li class="nav-item  ">
	                                    <a href="add_purchase.php" class="nav-link "> <span class="title">SAHARA</span>
	                                    </a>
	                                </li>
									 <li class="nav-item  ">
	                                    <a href="add_payments.php" class="nav-link "> <span class="title">IMPACT</span>
	                                    </a>
	                                </li>
									 <li class="nav-item  ">
	                                    <a href="payment_reports.php" class="nav-link "> <span class="title">PRABHAT KHABAR</span>
	                                    </a>
	                                </li>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="db_doctor.php" method="post" id="form_sample_1" class="form-horizontal">
                                        <div class="form-body">
										<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="date" data-required="1" placeholder="date" class="form-control input-height" /> </div>
                                            </div>
                                            </div>
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="Consignee" data-required="1" placeholder="enter Consignee" class="form-control input-height" /> </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Consignee GSTIN NO
                                                </label>
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        
                                                        <input type="text" class="form-control input-height" name="consignee_gst_no" placeholder="Consignee GSTIN NO"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="total_amount" data-required="1" placeholder="enter Total Amount" class="form-control input-height" /> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="Sale%" type="text" placeholder="Sale%" class="form-control input-height" /> </div>
                                            </div>
                                        	 ...
                                        	 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="cgst" placeholder="CGST" class="form-control-textarea"  ></textarea>
                                                </div>
                                            </div>
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="igst" placeholder="IGST" class="form-control-textarea"  ></textarea>
                                                </div>
                                            </div>
											<div class="form-group row">
                                                <label class="control-label col-md-3">TGST
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <textarea name="tgst" placeholder="TGST" class="form-control-textarea"  ></textarea>
                                                </div>
                                            </div>
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="payable" placeholder="Payable" class="form-control-textarea"  ></textarea>
                                                </div>
                                            </div>
