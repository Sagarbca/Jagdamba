...
<form action="chsnge_password_config.php" method="post"  class="form-horizontal">

<div class="form-body">
<div class="form-group row">
<label class="control-label col-md-3">Enter Old Password                                                                                            
<span class="required"> * </span>
</label>
<div class="col-md-5">
<input type="text" name="old_password"   class="form-control input-height" placeholder="Enter Old Password" /> </div>
...
<div class="col-md-5">
<input type="text" name="new_password"   class="form-control input-height" placeholder="Enter New Password" /> </div>
</div>
</div>
...
<div class="col-md-5">
<input type="text" name="confirm_new_password"   class="form-control input-height" placeholder="Confirm New Password" /> </div>
</div>
</div>
