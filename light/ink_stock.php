...
<div class=" pull-left">
<div class="page-title">Ink Stock</div>
</div>
...
<div class="btn-group">
<a href="add_ink_stock.php" id="addRow" class="btn btn-info">
...
<th class="center">Less Date</th>
<th class="center">Rest Stock After Less</th>
...
{ ?>
<tr>
<td class="center"><?php echo htmlentities($row->date);?></a></td>  
<td class="center"><?php echo htmlentities($row->name);?></a></td>

<td class="center"><?php echo htmlentities($row->manufacture);?></a></td>
<td class="center"><?php echo htmlentities($row->kg);?></a></td>
<td class="center"><?php echo htmlentities($row->less); ?></a></td>
<td class="center"><?php echo htmlentities($row->less_date);?></a></td>
<td class="center"><?php echo htmlentities($row->rest_stock);?></a></td>
<td class="center">
