...
<div class=" pull-left">
<div class="page-title">Add Clients</div>
</div>
...
<form action="clients.php" method="post"  class="form-horizontal">

<div class="form-body">
<div class="form-group row">
<label class="control-label col-md-3">Clients Name                                                                                            
<span class="required"> * </span>
</label>
<div class="col-md-5">
<input type="text" name="client_name"  placeholder="Name"  class="form-control input-height" /> </div>
</div>
</div>
<div class="form-body">
<div class="form-group row">
...
<div class="col-md-5">
<input type="text" name="mobile_no"  placeholder="enter Mobile no"   class="form-control input-height" /> </div>
</div>
...
<div class="col-md-5">
<input type="text" name="email_client"  placeholder="enter email id"  class="form-control input-height" /> </div>
</div>


<div class="form-group row">
<label class="control-label col-md-3">GST N0.

<span class="required">  </span>
</label>
<div class="col-md-5">
<input type="text" name="gst"  placeholder="enter gst No"  pattern="[a-zA-Z0-9]{15}"class="form-control input-height" /> </div>
</div>
...
<input type="text" class="form-control input-height" name="address" placeholder=" Enter Address Here"  /> </div>
</div>
</div>
...
<input type="text" class="form-control input-height" name="state" placeholder=" Enter State Here"  /> </div>
</div>
</div>
...
<input type="text" class="form-control input-height" name="state_code" placeholder=" Enter State Code Here"  /> </div>
</div>
</div>
<div class="row">
