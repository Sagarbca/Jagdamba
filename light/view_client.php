...
<button class="btn btn-info btn-action ecom-bg-csv m-l-10 pull-right" name="client"  style="margin-top: 1px;margin-left: 30%;" >Export</button>
</form>
</div>
...
{ ?><tr>
<td class="center nowrap"><a href="client_profile.php?edit=<?php echo $row->client_id ;?>"><?php echo htmlentities($row->client_id);?></a></td>  
<td class="center nowrap"><a href="client_profile.php?edit=<?php echo $row->client_id ;?>"><?php echo htmlentities($row->client_name);?></a></td>
<td class="center nowrap"><a href="client_profile.php?edit=<?php echo $row->client_id ;?>"><?php echo htmlentities($row->date); ?></a></td>

<td class="center "><a href="client_profile.php?edit=<?php echo $row->client_id ;?>"><?php echo htmlentities($row->mobile_no); ?></a></td>
<td class="center "><a href="client_profile.php?edit=<?php echo $row->client_id ;?>"><?php echo htmlentities($row->address);?></a></td>

<td>
<a href="client_product.php?edit1=<?php echo $row->client_id ;?>" class="btn btn-primary btn-xs" style="width: 98px;font-size: 9px;">
<strong>Add Product</strong>
</a>


<!--<a href="client_profile.php?edit=<?php echo $row->client_id ;?>" class="btn btn-danger btn-xs" style="display:none;">
<strong>view Profile</strong>
</a>-->

<a href="edit_client_view.php?edit1=<?php echo htmlentities($row->client_id);?>" class="btn btn-primary btn-xs" title="Edit">
<i class="fa fa-edit"></i>
</a>
<a onClick="javascript:return confirm('are you sure you want to delete this?');" href="delete_vendor.php?edit1=<?php echo $row->client_id;?>& name=client" class="btn btn-danger btn-xs" title="Delete">
