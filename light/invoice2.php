...
?>
<b> <?php echo $item['purchase_id'] ?></b></td>
<td>Date:

<b><?php echo $item['date'] ?></b></td>
</tr>
<tr>
<td>Cheque No.
...
<tr>
<th class="th_font" style="width: 42px;">S.No.</th>
<th class="th_font" style="width: 150px;">Particular</th>
<th class="th_font" style="width: 100px;">HSN/SAC</th>
<th class="th_font" style="width: 100px;">Quantity</th>
<th class="th_font" style="width: 58px;">per</th>
<th class="th_font" style="width: 68px;">Rate</th>
<th class="th_font" style="width: 60px;">Gst%</th>
<th class="th_font" style="width: 50px;">Cgst%</th>
<th class="th_font" style="width: 50px;">Cgst Amount</th>
<th class="th_font" style="width: 50px;">Sgst%</th>
<th class="th_font" style="width: 50px;">Sgst Amount</th>
<th class="th_font" style="width: 55px;">Amount</th>
</tr>
...
<th class="th_font"><?php echo $item1['per'] ?></th>
<th class="th_font"><?php echo $item1['rate'] ?></th>
<th class="th_font"><?php echo $item1['gst'] ?></th>
<th class="th_font"><?php echo $item1['cgst'] ?></th>
<th class="th_font"><?php echo $item1['cgst_amount'] ?></th>
<th class="th_font"><?php echo $item1['sgst'] ?></th>
<th class="th_font"><?php echo $item1['sgst_amount'] ?></th>
...
<td></td>
<td></td>
<th><b><u><?php echo $item['total_amount'] ?></u></b></th>
