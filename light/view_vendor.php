...
<div class=" pull-left">
<div class="page-title">All Vendor</div>
</div>
...
<thead>
<tr>
<th class="center" style="width:80px;"> Vendor Id</th>
<th class="center" style="width:180px;">Vendor Name</th>
<th class="center">GST NO</th>
<th class="center">Mobile</th>
<th class="center">Address</th>
<th class="center" style="width:199px;">Actions</th>
</tr>
</thead>
<tbody>
...
{ ?>
<tr>
<td class="center"><a href="vendor_profile.php?editsz=<?php echo $row->vendor_id ;?>"><?php echo htmlentities($row->vendor_id);?></a></td>  
<td class="center"><a href="vendor_profile.php?editsz=<?php echo $row->vendor_id ;?>"><?php echo htmlentities($row->vendor_name);?></a></td>

<td class="center"><a href="vendor_profile.php?editsz=<?php echo $row->vendor_id ;?>"><?php echo htmlentities($row->gst_no);?></a></td>
<td class="center"><a href="vendor_profile.php?editsz=<?php echo $row->vendor_id ;?>"><?php echo htmlentities($row->mobile_no); ?></a></td>
<td class="center"><a href="vendor_profile.php?editsz=<?php echo $row->vendor_id ;?>"><?php echo htmlentities($row->address);?></a></td>
<td style="">

<a href="add_invoice.php?edit1=<?php echo $row->vendor_id ;?>" class="btn btn-primary btn-xs" style="width: 98px;font-size: 9px;">Add invoice

</a>

<!--<a href="vendor_profile.php?editsz=<?php echo $row->vendor_id ;?>" class="btn btn-danger btn-xs" style="display:none;">
<strong>view Profile</strong>
</a>-->
<a href="edit_vendor.php?edit1=<?php echo $row->vendor_id ;?>" class="btn btn-primary btn-xs" title="Edit">
<i class="fa fa-edit"></i>
</a>
<a onClick="javascript:return confirm('are you sure you want to delete this?');" href="delete_vendor.php?edit1=<?php echo $row->vendor_id ;?>& name=vendor" class="btn btn-danger btn-xs" title="Delete">
