...
<form action="add_staff_config.php" method="post"  class="form-horizontal">
<div class="form-body">
...
<div class="col-md-5">
<input type="text" name="date"  placeholder="date" required class="form-control input-height" value="<?php echo date('Y-m-d');?>" /> </div>
</div>
</div>
<div class="form-group row">
...
<div class="col-md-5">
<input type="text" name="name"  placeholder="enter name"  required pattern="[a-z,A-Z\s]{3,30}"class="form-control input-height" /> </div>
</div>
...
<input type="text" class="form-control input-height" name="mobile_no"  pattern ="[0-9]{10}" placeholder="enter the mobile_no"> </div>
</div>
</div>
<div class="form-group row">
...
<div class="col-md-5">
<input type="text" name="aadhar_no"  placeholder="enter Aadhar no"  pattern ="[0-9]{12}"class="form-control input-height" /> </div>
</div>
...
<div class="col-md-5">
<input name="email" type="text" placeholder="enter the email"  class="form-control input-height" /> </div>
</div>

<div class="form-group row">
<label class="control-label col-md-3">Bank Account No.
<span class="required">  </span>
</label>
<div class="col-md-5">
<input name="acc_no" type="text" placeholder="enter bank account no." class="form-control input-height" /> </div>
</div>
...
<div class="col-md-5">
<textarea name="salary" placeholder="enter the salary here" required class="form-control-textarea"  ></textarea>
</div>
</div>
...
<div class="col-md-5">
<textarea name="address" placeholder="enter the address here" class="form-control-textarea"  ></textarea>
</div>
</div>
