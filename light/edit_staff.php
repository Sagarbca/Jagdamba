...
<div class="card-head">
<header style="text-align:center">Edit Staff </header>
...
<form action="edit_staff_config.php" method="post" id="form_sample_1" class="form-horizontal">
...
<div class="col-md-5">
<input type="text" name="staff_id"  placeholder="Name " class="form-control input-height" value='<?php echo htmlentities($row->staff_id);?>' /> </div>
</div>
</div>
<div class="form-body">
<div class="form-group row">
...
<div class="col-md-5">
<input type="text" name="staff_name" data-required="1" placeholder="Name " class="form-control input-height" value='<?php echo htmlentities($row->staff_name);?>' /> </div>
</div>
</div>
...
<div class="col-md-5">
<input type="text" name="email" data-required="1" placeholder="Name " class="form-control input-height" value='<?php echo htmlentities($row->email);?>' /> </div>
</div>
</div>
<div class="form-body">
<div class="form-group row">
...
<div class="col-md-5">
<input type="text" name="salary" data-required="1" placeholder="Name " class="form-control input-height" value='<?php echo htmlentities($row->salary);?>' /> </div>
</div>
</div>
<div class="form-body">
<div class="form-group row">
...
<a href="all_staff.php" style="color: black; padding-left: 550px; padding-bottom: 50px;"><button><span style="color: black;><i class="fa fa-print"></i> Back</span></button></a>															
<!-- end page content -->
...
<a href="succexa.in" target="_top" class="makerCss">Succexa</a>
</div>
