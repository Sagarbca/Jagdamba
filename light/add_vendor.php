...
<div class=" pull-left">
<div class="page-title">Add Vendors</div>
</div>
<ol class="breadcrumb page-breadcrumb pull-right">
<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="dashboard.php">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
</li>
<li><a class="parent-item" href="dashboard.php">JAGDAMBA </a>&nbsp;<i class="fa fa-angle-right"></i>
</li>
...
<form action="vendors.php" method="post"  class="form-horizontal">
<div class="form-body">
...
<div class="col-md-5">
<input type="text" name="vendor_name"  placeholder="Name"  required class="form-control input-height" /> </div>
</div>
</div>
<!-- <div class="form-group row">
...
<div class="col-md-5">
<input type="text" name="consignee"  placeholder="enter Consignee" required class="form-control input-height" /> </div>
</div>-->
...
<input type="text" class="form-control input-height" name="gst_no" required pattern="[a-zA-Z0-9]+{15}" placeholder=" GST NO"> </div>
</div>
</div>
<div class="form-group row">
...
<div class="col-md-5">
<input type="text" name="mobile_no"  placeholder="enter Mobile" required pattern ="[0-9]{10}" class="form-control input-height" /> </div>
</div>
<div class="form-group row">
...
<div class="col-md-5">
<input name="date" type="text"  required class="form-control input-height" readonly value='<?php echo date('d-m-Y');?>' /> </div>
</div>
...
<div class="col-md-5">
<input name="address" type="text" placeholder="Address" required class="form-control input-height" /> </div>
</div>
