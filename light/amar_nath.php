...
$query = "INSERT INTO test_ajax (product_name,hsn_code,quantity) VALUES ('".$mysqli->real_escape_string($product_name[$key])."','".$mysqli->real_escape_string($hsn_code[$key])."','".$mysqli->real_escape_string($quantity[$key])."')";
echo $query;
//mysqli_query($, $query);
