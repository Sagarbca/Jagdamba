...
<div class=" pull-left">
<div class="page-title">Add Spare Parts</div>
</div>
...
<li class="active">Add Spare Parts</li>
</ol>
</div>
</div>
...
<form action="add_spare_config.php" method="post"  class="form-horizontal">
...
<div class="form-body">
<div class="form-group row">
<label class="control-label col-md-3">Spare Parts Name                                 <span class="required"> * </span>
</label>
<div class="col-md-5">
...
<div class="col-md-5">
<input type="text" name="manufacture"  placeholder="enter Manufacturer Here"  class="form-control input-height" /> </div>
</div>
<div class="form-group row">
...
<div class="col-md-5">
<input type="text" name="stock"  placeholder="enter Stock here"   class="form-control input-height" /> </div>
</div>
<div class="form-group row">
<label class="control-label col-md-3">Used.

<span class="required">  </span>
</label>
<div class="col-md-5">
<input type="text" name="used"  placeholder="enter Used Here" class="form-control input-height" /> </div>
</div>

<div class="form-body">
<div class="form-group row">
<label class="control-label col-md-3">Used Date                                                                                           
<span class="required"> * </span>
</label>
<div class="col-md-5">
<input type="text" class="form-control input-height" name="used_date" placeholder=" Enter Used Date "  />  </div>
</div>
</div>

<div class="form-group row">
<label class="control-label col-md-3"> Rest Stock After Used 
</label>
<div class="col-md-5">
<div class="input-group">
<input type="text" name="rest_stock_after_used"  placeholder="Rest Stock After Used" class="form-control input-height"  /></div>
</div>
</div>
<div class="row">
