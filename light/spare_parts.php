...
<div class=" pull-left">
<div class="page-title">Spare Stock</div>
</div>
...
<li class="active">Spare Stock</li>
</ol>
</div>
</div>
<div class="row">
...
<div class="btn-group">
<a href="add_spare_stock.php" id="addRow" class="btn btn-info">
...
<th class="center" style="width:180px;">Spare Parts Name</th>
<th class="center">Manufacture</th>
<th class="center">Stock</th>
<th class="center">Used</th>
<th class="center">Used Date</th>
<th class="center" style="width:199px;">Rest Stock After Used</th>
</tr>
</thead>
<tbody>
<?php 
...
<td class="center"><?php echo htmlentities($row->manufacture);?></td>
<td class="center"><?php echo htmlentities($row->stock);?></td>
<td class="center"><?php echo htmlentities($row->used); ?></td>
<td class="center"><?php echo htmlentities($row->used_date);?></td>
<td class="center"><?php echo htmlentities($row->rest_stock_used);?></td>
</tr>
<?php } }
?>
</tbody>
