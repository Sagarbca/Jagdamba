...
<div class=" pull-left">
<div class="page-title">All Staff List</div>
</div>
...
<button class="btn btn-info btn-action ecom-bg-csv m-l-10 pull-right" style="margin-top: 1px;margin-left: 30%;" name="all_staff" >Export</button>
</form>
</div>
</div>
...
{ ?>
<tr>
<td class="center"><a href="profile.php?edit1=<?php echo $row->staff_id ;?>"><?php echo htmlentities($row->staff_id);?></a></td>
<td class="center"><a href="profile.php?edit1=<?php echo $row->staff_id ;?>"><?php echo htmlentities($row->staff_name); ?></a></td>
<td class="center"><a href="profile.php?edit1=<?php echo $row->staff_id ;?>"><?php echo htmlentities($row->address);?></a></td>
<td class="center"><a href="profile.php?edit1=<?php echo $row->staff_id ;?>"><?php echo htmlentities($row->mobile_no);?></a></td>

<td style="float: right;margin-right: 5%;">
<a href="staff_details.php?edit1=<?php echo $row->staff_id ;?>" class="btn btn-primary btn-xs" style="width: 98px;font-size: 9px;">Staff_expense

</a>
<!--<a href="profile.php?edit1=<?php echo $row->staff_id ;?>" class="btn btn-danger btn-xs" style="display:none;">View Profile

</a>-->

<a href="edit_staff.php?edit1=<?php echo $row->staff_id ;?>" class="btn btn-primary btn-xs" title="Edit">
<i class="fa fa-edit"></i>
</a>
<a onClick="javascript:return confirm('are you sure you want to delete this?');" href="delete_vendor.php?edit1=<?php echo $row->staff_id;?>& name=staff" class="btn btn-danger btn-xs" title="Delete">
