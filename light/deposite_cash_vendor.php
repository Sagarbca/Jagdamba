...
$querymaxcount = "SELECT max(invoice_id) AS max_id FROM `vendor_invoice` WHERE  vendor_id = '$vendor_id'";
...
$sql = "SELECT * FROM vendor_invoice WHERE invoice_id = '$maxpurchaseid'";
...
<div class="col-md-5">
<input type="text" name="dues"  placeholder="Dues Amount"  value='<?php echo htmlentities($row->pv_dues_remaining);?>' class="form-control input-height"  /> </div>
</div>
</div>
...
<div class="col-md-5">
<input type="text"  name="payble"  placeholder="Paid Dues Amount."  class="form-control input-height" required> 
...
<div class="col-md-5">
<input name="cheque_no" type="text" placeholder="Cheque NO." class="form-control input-height"  > </div>
</div>
...
<div class="col-md-5">
<input name="remarks" type="text" placeholder="Remarks here ." class="form-control input-height"  > </div>
</div>
