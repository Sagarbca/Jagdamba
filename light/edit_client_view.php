...
$sql = "SELECT * from  clients WHERE client_id ='$vendor_id'";
...
<form action="edit_client.php" method="post" id="form_sample_1" class="form-horizontal">
...
<div class="col-md-5">
<input type="text" name="client_id" data-required="1" placeholder="Name " class="form-control input-height" value='<?php echo htmlentities($row->client_id);?>' /> </div>
</div>
<div class="form-group row">
...
<div class="col-md-5">
<input type="text" name="client_name" data-required="1" placeholder="Name " class="form-control input-height" value='<?php echo htmlentities($row->client_name);?>' /> </div>
</div>
</div>
