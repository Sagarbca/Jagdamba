...
$mysqli = NEW Mysqli('localhost','root','~f_uR)+v,*bS','jagdamba');
...
<h1 style="text-align: center;"> Staff Security Money Deposit Form </h1>
<div class="card-body" id="bar-parent">
<form action="deposit_security_config.php" method="post"  class="form-horizontal">
...
<div class="form-body">
<div class="form-group row">
<label class="control-label col-md-3">Remaining Balance                                                                                           
<span class="required"> * </span>
</label>
<div class="col-md-5">
<input type="text" name="remaining_balance" data-required="1"  placeholder="Name " class="form-control input-height" value='<?php echo $pv_security_amt;?>' readonly /> </div>
</div>
...
<div class="col-md-5">
<input type="text" name="deposit_remarks"  placeholder="Remarks Here " class="form-control input-height"  /> </div>
</div>
</div>
<input type="hidden" name="page_name" value="deposit_page"  />
