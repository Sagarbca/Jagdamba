...
<form action="add_ink_config.php" method="post"  class="form-horizontal">
...
<div class="form-body">
<div class="form-group row">
<label class="control-label col-md-3">Vendor's/Client Name                                                                                           
<span class="required"> * </span>
</label>
<div class="col-md-5">
...
<div class="col-md-5">
<input type="text" name="manufacturer"  placeholder="enter Manufacturer"   class="form-control input-height" /> </div>
</div>

<div class="form-group row">
<label class="control-label col-md-3">Kg
...
<div class="form-group row">
<label class="control-label col-md-3">Less.

<span class="required">  </span>
</label>
<div class="col-md-5">
<input type="text" name="less"  placeholder="enter Less Here" class="form-control input-height" /> </div>
</div>

<div class="form-body">
<div class="form-group row">
<label class="control-label col-md-3">Less Date                                                                                           
<span class="required"> * </span>
</label>
<div class="col-md-5">
<input type="text" name="less_date"  placeholder="Less Date" class="form-control input-height"value='<?php echo date('d-m-Y');?>' readonly /> </div>
</div>
</div>

<div class="form-group row">
<label class="control-label col-md-3"> Rest Stock After Less
</label>
<div class="col-md-5">
<div class="input-group">

<input type="text" class="form-control input-height" name="rest_stock_after_less" placeholder=" Enter Rest Stock"  /> </div>
</div>
</div>
<div class="row">
