...
<tr>
<td colspan="6" align="center"><h3>  Tax Invoice</h3></td>
<td colspan="3"><h3>Date <?php  $datee= $item['datept']; echo date('d-m-Y', strtotime($datee)) ?></h3></td>
<td colspan="3"><h3>Invoice No: <?php echo $item['purchase_id'] ?></h3></td>
</tr>
<tr>
...
<td colspan="6">
<b> Consignee </b><br>
Name : <b><?php echo strtoupper($item['client_name'])  ?></b><br>
<span>Address: <?php echo $item['address'] ?> <span><br>
Phone: <?php echo $item['mobile_no'] ?><br> 
Email:  <?php echo $item['email_client'] ?><br>
GST NO: <?php echo $item['gst_no'] ?><br>
State: <?php echo $item['state'] ?>, Code: <?php echo $item['state_code'] ?><br>
...
<td colspan="1" ><b><?php echo $item1['product_name'] ?></b></td>
<td colspan="2" style="text-align: center;"><?php echo $item1['hsn_code'] ?></td>
<td style="text-align: center;"><?php echo $item1['gst'] ?>%</td>
<td style="text-align: center;"><?php echo $item1['per'] ?></td>
<td style="text-align: center;"><?php echo $item1['quantity'] ?></td>
<td align="right" style="text-align: center;"><?php echo $item1['rate'] ?></td>
<td align="right" colspan="2" style="text-align: center;" ><b><?php echo $item1['amount'] ?></b></td>
...
<td align="right" colspan="4"><b> <?php echo $item['tsum'] ?></b></td>
</tr>
<tr>
<td colspan="5"></td>
<td colspan="3">Discount</td>

<td align="right" colspan="4"> <?php echo $item['discount'] ?></td>
</tr>
...
<td align="right" colspan="4"> <b><?php echo $abt =  ((float)$item['tsum'] - (float)$item['discount']);?></b></td>
</tr>
<tr>
...
<td><?php $hsn =   $item11['hsn_code']; echo $hsn; ?></td>
...
?>
<td align="right"> <?php  $cgst = $item111['cgst']; echo $cgst; ?></td>

<td align="right"><?php $cgstamt = $cgst*$amt/100;  echo $cgstamt;
...
?></td>
<td align="right"><?php $sgst = $item111['sgst']; echo $sgst;?></td>


<td align="right"><?php echo $sgst*$amt/100; 
$sgst_sum += $sgst*$amt/100;

?></td>
<td align="right"><?php $igst = $item111['igst']; echo $igst; ?></td>
<td align="right"><?php 
...
$igst_am = $item111['igst_amount']; echo $igst_am;
...
<td align="right"><?php echo  $amt1; ?></td>
...
<td align="right">
    <?php
$result3 = $db->query ( "SELECT (SELECT SUM(igst_amount) FROM product_master WHERE purchase_id = '$purchase_id') as igst_tot,
pt.gst_total 
...
$totalg = $item3['gst_total'];
$totalig = $item3['igst_tot'];
break;
}
$igst_plus_gst = $totalg + $totalig;
?>
<?php 
echo number_format($totalig,2);
?>
</td>
</tr>
<tr>
...
<td align="right" style="border-top: 1px solid black;"><b> <?php echo number_format($igst_plus_gst,2); ?></b></td> 
</tr>
<tr>
...
<td align="right"><b> <?php $data1 =  $item['net_amount'];  echo $data1; ?></b></td>
</tr>
</table>
</td>
</tr>
