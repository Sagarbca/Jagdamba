...
$query_purchase = "INSERT INTO `purchase_table`(`purchase_id`,  `client_id`,`tsum`,`gst_total`, `totalPrice`, `discount`, `net_amount`, `payble`, `dues`, `payment_method`, `deposite_account`,`total_due`,`status`,`utr_no`) VALUES ('$purchase_id','$client_id','$tsum','$gst_total','$totalPrice','$discount','$net_amount','$payble','$dues','$payment_mode','$deposite_account','$total_due_1','$duestatus','$utr_no')";
  echo $query_purchase;
