...
$sql = "SELECT * from clients_product WHERE product_id = '$vendor_id'";
...
<b> 
<?php echo htmlentities($row->gst_no);?><br></b></td>
...
<th style="width: 108px;"><?php echo htmlentities($row->rate);?></th>
<th style="width: 195px;"><?php echo substr($row->amount,0,5);?></th>
</tr>
<tr>
...
width: 108px;"> </th>
<th style="
width: 195px;"><b><u><?php echo substr($row->tm,0,5);?></u></b></th>
</tr>
<tr>
<th style="
width: 62px;"></th>
