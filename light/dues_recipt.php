...
<body> 
<h2 style="text-decoration-line: underline;"> <center> JAGDAMBA PRINT LINE</center></h2>
<br>
<br>
<div class="container">
<div class="row">
...
<div class="col-sm-4">
<h5><p style="margin-left: 
90px;">Date:<label style="text-decoration-line: underline; "></label><?php echo htmlentities($row->doe);?></p></h5>
</div>
</div>
...
<div class="col-sm-4">
<h5><p style="margin-left: 
90px;"><label style="text-decoration-line: underline;">Dues Recipt Invoice</label></p></h5> 
</div>
<div class="col-sm-4">
</div>
</div>
...
<table style="width:100%">
<tr>
<th colspan="2"> Customer's Signature
</th>
<td> <label></label>
<hr><b>SIGNATURE</b>
</td>
